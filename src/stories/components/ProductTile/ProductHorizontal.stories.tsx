...
export const Large: StoryMeta<typeof ProductTileHorizontal> = {
	args: {
		...
		productName: "Zoom Janoski Canvas Premium Skateschuhe",
		imageUrl:
			"https://images.blue-tomato.com/is/image/bluetomato/305011128_front.jpg-fqby-dYy42g8wuknk5UgMAnj_4E/Franchise+Handschuhe.jpg?$tsl$&wid=138&hei=184&fit=crop%2C1",
		price: 59.95,
	},
	render: (args) => {
		const [quantity, setQuantity] = useState(args.quantity);
