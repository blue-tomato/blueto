		...
		return (
			...
			>
				<div className={styles.imageContainer}>
					...
					{onWishlistClick && <WishlistButton active={wishlistActive} onClick={handleWishlistClick} />}
				</div>
				...
				<div className={styles.infoContainer}>
					...
					{sizes.length > 0 && (
						<div ref={sizesRef} className={classNames(styles.swatchContainer, { [styles.expanded]: isSizesExpanded })}>
